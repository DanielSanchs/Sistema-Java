...
public class JDlgVendasPesquisa extends javax.swing.JDialog {
    ...
    private VendasPesquisa vendasPesquisa;
    ...
    public JDlgVendasPesquisa(java.awt.Frame parent, boolean modal) {
        ...
        ArrayList lista = vendasDAO.listAll();
        vendasPesquisa = new VendasPesquisa();
        vendasPesquisa.setList(lista);
        jTable2.setModel(vendasPesquisa);
    }
    
    public void setTelaAnterior(JDlgVendas telaVendas){
            this.jDlgVendas = telaVendas;
    }
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        if(jTable2.getSelectedRow() != -1){
            jDlgVendas.beanTela(vendasPesquisa.getRegistro(jTable2.getSelectedRow()));
        }
        setVisible(false);
	...
	if(pos <= vendasPesquisa.getRowCount()+1){
